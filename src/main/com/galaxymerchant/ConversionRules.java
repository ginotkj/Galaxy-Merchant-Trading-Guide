...
public class ConversionRules {
    ...
    /**
     * checkLiteralCountValidity() method keeps the count of all repeatable and
     * non repeatable Literals.
     *
     */
    ...
    /**
     * getKeyForValueContainingThree() method returns the key corresponding to
     * value 3.This is used while checking the count of Literals that cannot be
     ...
     * applied when repeatable literals can occur 4 times only if the 3rd and
     * 4th occurance has a smaller value between them.
     *
    ...
    /**
     * Applies the subtaction logic and checks if the element is subtractable by
     * the other or not.
     *
     * @param lastDecimal
     * @param decimal
